...
The implementation is original glue and policy code built around public libraries. `dom-to-pptx` was consulted as a design reference but is not installed as a runtime dependency or used as an unchecked exporter, because this project requires stricter fail-closed raster behavior and manifest/OOXML proof. PptxGenJS is the native object writer.
